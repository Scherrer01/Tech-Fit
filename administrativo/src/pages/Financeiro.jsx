    ...
    <main style={{ marginLeft: "18vw", padding: "2rem", position: "relative", zIndex: 5 }}>
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-6">
          <div>
            <h1 className="text-2xl font-bold text-green-950">Relatórios Financeiros</h1>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-xl font-bold mt-1 ${indicadores.margemLucro >= 0 ? 'text-green-600' : 'text-red-600'}`}>
      ...
      {loading ? (
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-12">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-4 text-lg font-semibold text-gray-700">Gerando relatório financeiro...</p>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {relatorioData.receitas.map((item, index) => (
                  <div key={index} className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-bold text-green-600">{formatarMoeda(item.valor)}</span>
                    </div>
            ...
            {/* Plano Mais Vendido */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Plano Mais Popular</h3>
              <div className="flex flex-col items-center justify-center py-6">
                <div className="text-6xl mb-4 text-green-600">🏆</div>
                <div className="text-2xl font-bold text-gray-800 mb-2">{relatorioData.planoMaisVendido}</div>
                ...
                <div className="bg-green-50 rounded-lg p-4 w-full">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-600">{relatorioData.planoVendas}</div>
          ...
          {relatorioData.inadimplentes.length > 0 && (
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              <div className="p-6 border-b border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800">Inadimplência</h3>
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="py-3 px-6 text-left text-sm font-semibold text-gray-700">Aluno</th>
                      <th className="py-3 px-6 text-left text-sm font-semibold text-gray-700">Valor Devido</th>
                      <th className="py-3 px-6 text-left text-sm font-semibold text-gray-700">Dias em Atraso</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {relatorioData.inadimplentes.map((item, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="py-4 px-6 text-sm text-gray-800">{item.aluno}</td>
                        <td className="py-4 px-6">
                          <span className="font-semibold text-red-600">{formatarMoeda(item.valor)}</span>
                        </td>
                        <td className="py-4 px-6">
                          <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                            item.diasAtraso <= 15 ? 'bg-yellow-100 text-yellow-800' :
                            item.diasAtraso <= 30 ? 'bg-orange-100 text-orange-800' :
