function Button({
  ...
  const baseClass =
    "relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group";
  ...
  return (
    <button
      type={type}
      disabled={disabled}
      className={`${baseClass} ${className} ${stateClass}`.trim()}
      {...rest}
    >
