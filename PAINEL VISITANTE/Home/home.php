...
<section class="hero">
    ...
    <a href="/PAINEL VISITANTE/registro/register.php">
        <button class="primary-btn">Se cadastre gratuitamente</button>
    </a>
    <a href="/PAINEL VISITANTE/planos/planos.php" class="btn-link">
        <button class="secondary-btn">Conheça Nossos Planos</button>
    </a>
</div>
...
<section class="cta-section">
    <div class="cta-content">
        ...
        <p>Faça seu cadastro e venha conhecer a Tech Fit</p>
        <a href="/PAINEL VISITANTE/Registro/register.php">
            <button class="primary-btn">Fazer Cadastro</button>
        </a>
    </div>
</section>
