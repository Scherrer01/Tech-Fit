...
<body>
    <style>
        * {
        ...
        .sidebar {
            ...
            /* fundo quase opaco 90% (0.9) de opacidade*/
            backdrop-filter: blur(10px);
            /* coloca um filtro no background, desfocando o fundo*/
            border-right: 1px solid rgba(255, 38, 38, 0.3);
            /* borda na direita na cor vinho*/
        ...
        /* div.logo{
            background-image: url(justgorila.png);
        ...
        .logo-text {
            ...
            font-weight: 700;
            text-align: center;
            background: linear-gradient(90deg, #f49595, #ff0000);
        ...
        .dashboard {
            ...
            /* fadeIn gera o efeito de chegar suavemente, vindo de baixo*/
        }
    ...
    <aside class="sidebar">
        ...
        <ul id="sair">
            <!-- From Uiverse.io by mishary_5473 -->
    ...
    <main class="dashboard">
        <section class="topstats">
            ...
            <div class="card" id="cancelamentos">
                <p class ="title-text">Cancelamentos:</p>
                <span style="text-align: center;"><strong>15</strong></span>
            </div>
            <div class="card" id="modalidades">
                <p class ="title-text">Modalidades:</p>
                <span style="text-align: center;"><strong>12</strong></span>
            </div>
        </section>
